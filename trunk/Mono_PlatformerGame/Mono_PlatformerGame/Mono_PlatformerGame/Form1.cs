...
//using Microsoft.Xna.Framework.Content.Pipeline.Serialization.Intermediate; //TODO
...
namespace Mono_PlatformerGame
{
    ...
    public partial class uxForm1 : Form
    {
        ...
        private void SaveLevel(string fileName, string fileNameOnly)
        {
            ...
            {
                //IntermediateSerializer.Serialize<LevelContent>(writer, levelSpec, null); //TODO
            }
